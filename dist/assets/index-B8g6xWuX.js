 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function RF(n){SF(n,(e,t)=>new iD(e,t,new wF)),n.registerVersion(vF,EF)}RF(ku);const CF={apiKey:"AIzaSyDs2qr5Kzod2pdFTCeUzr27ge2gOQlZM4g",authDomain:"react-app-mini-blog-f3621.firebaseapp.com",projectId:"react-app-mini-blog-f3621",storageBucket:"react-app-mini-blog-f3621.firebasestorage.app",messagingSenderId:"349056831117",appId:"1:349056831117:web:a0972c1ed7e02e9c545cc4"},xF=ku.initializeApp(CF),va=xF.firestore();function $u(n){const e=String(n.userId),[t,r]=Y.useState({id:0,name:"오류"});return Y.useEffect(()=>{console.log("사용자자 로드 시도"),console.log("입력값",e),va.collection("user").doc(e).get().then(a=>{r(a.data()),console.log("로드된 사용자",t)})},[e]),t?B.jsx("span",{children:t.name}):B.jsx("span",{children:"사용자"})}const DF=Re.div`
    margin: 0px;
    padding: 4px 0;
    display: block;
...
height: 100%;
`;function CT(n){const e=String(n.userId),[t,r]=Y.useState({id:0,name:"오류"});return Y.useEffect(()=>{va.collection("user").doc(e).get().then(a=>{r(a.data())})},[e]),t?B.jsx(VF,{src:t.img}):B.jsx("div",{})}const MF=Re.div`
  width: 60px;
  height: 100vh;
  position: fixed;
  left: 0;
...
`,QF=Re.div`
    ...
    gap: 16px;
    color: #666666;
`;function WF(n){const{post:e,onClick:t}=n;return B.jsxs(GF,{onClick:t,children:[B.jsxs(KF,{children:[B.jsx($u,{userId:e.writer}),"님의 게시물입니다."]}),B.jsx($F,{children:e.title}),B.jsxs(QF,{children:[B.jsx(Lp,{iconLink:"fa-regular fa-heart"})," ",B.jsx(Lp,{iconLink:"fa-regular fa-comment-dots"}),"작성일자 | ",e.formattedDate]})]})}const YF=Re.div`
  background-color: #ffffff;
  display: flex;
  flex-direction: column;
  gap: 20px
...
`;function JF(n){const e=vm(),[t,r]=Y.useState({none:!0,mon:!1,tues:!1,wednes:!1,thurs:!1,fri:!1,satur:!1,sun:!1}),a=p=>{r({none:!1,mon:!1,tues:!1,wednes:!1,thurs:!1,fri:!1,satur:!1,sun:!1,[p]:!0})},o=Object.keys(t).filter(p=>t[p]),[u,d]=Y.useState([]);return Y.useEffect(()=>{let p=[];va.collection("post").get().then(function(m){m.forEach(function(v){p.push(v.data())});const _=p.filter(v=>o.some(w=>v.daylabel[w]));d(_)})},[o]),B.jsxs("div",{children:[B.jsx(xT,{}),B.jsx(DT,{pageTitle:"Mainpage",buttonTitle:"글쓰기",onClick:p=>{e("/write")}}),B.jsxs(ZF,{children:[B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.none,onChange:()=>a("none")}),B.jsx("h5",{children:"요일무관"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.mon,onChange:()=>a("mon")}),B.jsx("h5",{children:"월"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.tues,onChange:()=>a("tues")}),B.jsx("h5",{children:"화"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.wednes,onChange:()=>a("wednes")}),B.jsx("h5",{children:"수"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.thurs,onChange:()=>a("thurs")}),B.jsx("h5",{children:"목"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.fri,onChange:()=>a("fri")}),B.jsx("h5",{children:"금"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.satur,onChange:()=>a("satur")}),B.jsx("h5",{children:"토"})]}),B.jsxs(Qs,{children:[B.jsx("input",{type:"radio",checked:t.sun,onChange:()=>a("sun")}),B.jsx("h5",{children:"일"})]}),B.jsx("p",{children:"검색을 원하는 요일을 선택해주세요!"})]}),B.jsx(XF,{posts:u,itemClicked:p=>{e(`/post/${p.id}`)}})]})}const e5=Re.div`
...
`,n5=Re.textarea`
    ...
    margin-bottom: 20px;
    padding: 20px;
`;function uo(n){const{height:e,value:t,onChange:r,title:a,description:o,type:u}=n;return B.jsxs(e5,{children:[B.jsxs(t5,{children:[B.jsx("h1",{children:a||"작성하세요."}),B.jsx("p",{children:o})]}),!u&&B.jsx(n5,{height:e||80,value:t,onChange:r})]})}const r5=Re.div`
width: 600px;
margin-left: auto;
margin-right: auto;
display: flex;
...
`,s5=Re.form`
  ...
  background-color: #FFB938;}
`;function a5(n){const e=vm(),{userId:t}=RT(),[r,a]=Y.useState({none:!0,mon:!1,tues:!1,wednes:!1,thurs:!1,fri:!1,satur:!1}),[o,u]=Y.useState("");Y.useEffect(()=>{const k=new Date,L=k.getFullYear(),H=String(k.getMonth()+1).padStart(2,"0"),X=String(k.getDate()).padStart(2,"0"),oe=["일","월","화","수","목","금","토"][k.getDay()];u(`${L}-${H}-${X}, ${oe}요일`)},[]);const d=k=>{a(k==="none"?{none:!r.none,mon:!1,tues:!1,wednes:!1,thurs:!1,fri:!1,satur:!1,sun:!1}:L=>{const H={...L,[k]:!L[k],none:!1};return Object.keys(H).every(K=>K==="none"||H[K]===!1)&&(H.none=!0),H})},[p,m]=Y.useState(""),[_,v]=Y.useState(""),[w,S]=Y.useState(""),D=()=>{let k=new Date().getTime().toString();va.collection("post").doc(k).set({id:k,writer:t,formattedDate:o,daylabel:r,title:p,subtitle:w,content:_,comments:[]}).then(()=>{alert("글이 등록되었습니다!"),e("/")})};return B.jsxs("div",{children:[B.jsx(xT,{}),B.jsx(DT,{pageTitle:"글을 작성하세요.",buttonTitle:"게시하기",onClick:k=>{D()}}),B.jsxs(r5,{children:[B.jsxs(i5,{children:[B.jsx(uo,{title:"작성자",description:B.jsx($u,{userId:t}),type:"."}),B.jsx(uo,{title:"작성일",description:o,type:".",height:"56",value:o})]}),B.jsx(uo,{title:"관련요일",description:"*중복선택가능",type:".",height:"56",value:_}),B.jsxs(s5,{children:[B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.none,onChange:()=>d("none")}),B.jsx("h5",{children:"요일무관"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.mon,onChange:()=>d("mon")}),B.jsx("h5",{children:"월"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.tues,onChange:()=>d("tues")}),B.jsx("h5",{children:"화"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.wednes,onChange:()=>d("wednes")}),B.jsx("h5",{children:"수"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.thurs,onChange:()=>d("thurs")}),B.jsx("h5",{children:"목"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.fri,onChange:()=>d("fri")}),B.jsx("h5",{children:"금"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.satur,onChange:()=>d("satur")}),B.jsx("h5",{children:"토"})]}),B.jsxs(Ws,{children:[B.jsx("input",{type:"checkbox",checked:r.sun,onChange:()=>d("sun")}),B.jsx("h5",{children:"일"})]})]}),B.jsx(uo,{title:"제목",height:"56",value:p,onChange:k=>m(k.target.value)}),B.jsx(uo,{title:"부제목",height:"56",value:w,onChange:k=>S(k.target.value)}),B.jsx(uo,{title:"내용",height:"121",value:_,onChange:k=>v(k.target.value)})]})]})}const o5=Re.div`
    display: flex;
    background-color: #ffffff;
    padding: 0;
...
justify-content: center;
align-items: center;
`;function y5(n){const{postId:e}=n,{userId:t}=RT(),[r,a]=Y.useState(""),[o,u]=Y.useState([]),[d,p]=Y.useState("");Y.useEffect(()=>{const w=new Date,S=w.getFullYear(),D=String(w.getMonth()+1).padStart(2,"0"),k=String(w.getDate()).padStart(2,"0");p(`${S}.${D}.${k} 작성`)},[]);const m=()=>{let w=[];va.collection("comments").get().then(function(S){S.forEach(function(k){w.push(k.data())});const D=w.filter(k=>k.post==e);u(D)})};Y.useEffect(()=>{m()},[]);const _=o.map((w,S)=>B.jsx(d5,{comments:w,onClick:D=>itemClicked(post)},w.id)),v=()=>{let w=new Date().getTime().toString();va.collection("comments").doc(e+"CM"+w).set({post:e,time:d,id:w,writer:t,comment:r}).then(()=>{alert("댓글이 등록되었습니다!"),a(""),m()})};return B.jsxs(f5,{children:[B.jsxs(m5,{children:[B.jsxs("div",{children:[B.jsx(g5,{children:B.jsx(CT,{userId:t})}),B.jsxs("h1",{children:[B.jsx($u,{userId:t}),"님"]})]}),B.jsx(cD,{title:"댓글작성",onClick:v})]}),B.jsxs(p5,{children:[B.jsx(uo,{height:"20",title:"댓글을 입력하세요.",value:r,onChange:w=>{a(w.target.value)}}),_]})]})}const _5=Re.div`
    width: 680px;
    margin-left:auto;
    margin-right:auto;
    position: relative;
...
`;function b5(n){const{post:e}=n;return B.jsxs(_5,{children:[B.jsxs(v5,{children:[B.jsx("h1",{children:e.title||"제목이 없습니다."}),B.jsx("p",{})]}),B.jsx(E5,{children:e.content||"내용이 없습니다."}),B.jsxs(T5,{children:[B.jsxs(w5,{children:[B.jsxs("h5",{children:[B.jsx($u,{userId:e.writer}),"님에 의하여"]}),B.jsxs("h5",{children:[e.formattedDate,"에 작성"]})]}),B.jsx(Lp,{iconLink:"fa-regular fa-heart"})," ",B.jsx(Lp,{iconLink:"fa-regular fa-comment-dots"})]})]})}const I5=Re.div`
  background-color: #ffffff;
  display: flex;
  flex-direction: row;
  justify-content: space-between;
...
`,A5=Re.div`
  flex: 1;
  padding-right: 20px;
`;function S5(n){const e=bO().id,[t,r]=Y.useState({id:0,comments:[],content:"",day:"",daylabel:[{fri:!1},{mon:!1},{none:!0},{satur:!1},{thurs:!1},{tues:!1},{wednes:!1}],subtitle:"",title:"",writer:"1"});return Y.useEffect(()=>{console.log("데이터 로드 시도"),va.collection("post").doc(e).get().then(a=>{r(a.data()),console.log("로드된 데이터:",t)})},[]),B.jsxs("div",{children:[B.jsx(xT,{}),t?B.jsxs(I5,{children:[B.jsxs(A5,{children:[B.jsx(DT,{pageTitle:t.subtitle||`${t.title||"부제목이 없습니다."}`}),B.jsx(b5,{post:t})]}),B.jsx(y5,{postId:e})]}):B.jsx("p",{children:"Loading..."})]})}const R5=Re.div`
  margin-left: 60px;
  box-sizing: border-box;
  padding: 0px 20px;
